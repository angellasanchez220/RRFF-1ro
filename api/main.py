...
from api.routes import auth, sop, upload, maquila, maquila_ordenes, export, forecast
...
app.include_router(forecast.router, prefix="/api/sop", tags=["Forecast"], dependencies=[Depends(require_authenticated)])
